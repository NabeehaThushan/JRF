  ...
  return (
    <main className="container">
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 16 }}>
        <div>
          <p className="muted" style={{ margin: 0 }}>← <Link href="/" style={{ color: "#888" }}>Dashboard</Link></p>
      ...
      <div className="card">
        ...
        <p className="meta"><strong>Vacancy reason:</strong> {req.vacancy_reason === "resignation" ? "Resignation" : "New budgeted position"}</p>
        {req.predecessor_name && <p className="meta"><strong>Predecessor:</strong> {req.predecessor_name}</p>}
      ...
      {req.status === "ready_to_publish" && (
        <div className="card" style={{ borderLeft: "4px solid #2ecc71" }}>
          ...
          <p className="muted">All stages complete. This requisition is approved and ready to go live.</p>
        </div>
      )}
    </main>
  );
